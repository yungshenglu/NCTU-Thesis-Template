...
'objPPT.Visible = True
Set objPresentation = objPPT.Presentations.Open(inputFile,,,msoFalse)

	
'Set objPresentation = objPPT.ActivePresentation
Set objPrintOptions = objPresentation.PrintOptions

objPrintOptions.Ranges.Add 1,page
objPrintOptions.RangeType = ppPrintSlideRange
objPrintOptions.ActivePrinter = "MS Publisher Color Printer"
objPrintOptions.PrintInBackground = msoFalse
objPrintOptions.HighQuality = True
objPresentation.PrintOut page,page,outputFile
